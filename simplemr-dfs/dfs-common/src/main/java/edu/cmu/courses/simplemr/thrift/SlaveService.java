...
public class SlaveService {
  ...
  public interface Iface {
    ...
    public SlaveWorkload heartbeat() throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public SlaveWorkload recv_heartbeat() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class heartbeat_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public SlaveWorkload getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class heartbeat<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, heartbeat_args, SlaveWorkload> {
      public heartbeat() {
        super("heartbeat");
      }
      ...
      public AsyncMethodCallback<SlaveWorkload> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<SlaveWorkload>() { 
          public void onComplete(SlaveWorkload o) {
            heartbeat_result result = new heartbeat_result();
            result.success = o;
            try {
      ...
      public void start(I iface, heartbeat_args args, org.apache.thrift.async.AsyncMethodCallback<SlaveWorkload> resultHandler) throws TException {
...
;
  ...
  public static class heartbeat_result implements org.apache.thrift.TBase<heartbeat_result, heartbeat_result._Fields>, java.io.Serializable, Cloneable, Comparable<heartbeat_result>   {
    ...
    public SlaveWorkload success; // required
    ...
    public heartbeat_result(heartbeat_result other) {
      if (other.isSetSuccess()) {
        this.success = new SlaveWorkload(other.success);
      }
    }
    ...
    public SlaveWorkload getSuccess() {
      return this.success;
    }

    public heartbeat_result setSuccess(SlaveWorkload success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((SlaveWorkload)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new SlaveWorkload();
